...
def combo1execution():
    basename = 'bot1'
    combo1proc = webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo2execution():
    basename = 'bot2'
    combo2proc = webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo3execution():
    basename = 'bot3'
    combo3proc= webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo4execution():
    basename = 'bot4'
    combo4proc= webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo5execution():
    basename = 'bot5'
    combo5proc= webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo7execution():
    basename = 'bot7'
    combo7proc= webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
...
def combo8execution():
    basename = 'bot8'
    execution= webdriver.Chrome(executable_path='C:\webdrivers\chromedriver\chromedriver.exe')
    print execution.title
